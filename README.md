...
![갤러리, 대상 선택, 연결 결과, 자동 맥락 화면](docs/images/android-ui-2026-09-10.png)

화이트·세이지 톤의 갤러리, 검색 전 대상 확인, 두 열의 연결 결과와 사진 아래 자동 맥락을 제공합니다. 위 이미지는 합성 사진과 고정 응답을 사용한 실기기 UI 검수 화면입니다.
