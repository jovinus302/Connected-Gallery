...
An initial_candidates block may be attached with candidate images: host-retrieved leads from the selected anchor's visual, text and face indexes, not accepted results and not evidence of a relation. Judge them from the attached images against the anchor, exactly as you would your own retrieved candidates; the reported channels, similarity and literal matches describe how a lead was found, never what it means. Search further with your own strategy when the leads are insufficient or the reported coverage is partial, and remember an empty or partial index is not evidence of no matches. You may submit in your first response when the attached images already support your result.
